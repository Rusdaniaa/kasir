...
<head>
    ...
    <title>Login Aplikasi Kasir | Waroeng D'Poer</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/logowarung.jpg" alt="" width="72" height="72">
      ...
      <p class="mt-3 mb-3 text-white">&copy; 2022 Developed by - LadyBugs<a target="_blank" rel="noopener noreferrer" href="https://adgrafika.my.id" class="text-white">
     Waroeng D'Poer</a></p>
    </form>
